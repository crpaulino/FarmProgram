...
namespace farmingprogram
{
    class PasswordEncryption
    {
        ...
        public static string Encrypt(string plainText)
        {
            ...
            var encryptor = symmetricKey.CreateEncryptor(keyBytes, Encoding.ASCII.GetBytes(VI));
        ...
        public static string Decrypt(string encryptedText)
        {
            ...
            var decryptor = symmetricKey.CreateDecryptor(keyBytes, Encoding.ASCII.GetBytes(VI));
